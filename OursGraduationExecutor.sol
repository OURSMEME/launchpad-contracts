...
/**
 * @title OursGraduationExecutor
 * @notice Performs the two heaviest steps of Ours graduation on
 * OursLaunchFactory's behalf: swapping swept ETH for a non-native
 * pairToken, and minting the full-range Uniswap V4 position. Split out into
 * its own contract purely so OursLaunchFactory's own bytecode stays under
 ...
 */
contract OursGraduationExecutor {
