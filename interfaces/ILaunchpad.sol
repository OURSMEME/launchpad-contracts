...
/**
 * @notice Shared Ours interfaces: fee escrow, fee policy, and the launch
...
interface IOursFeePolicy {
    ...
    function feeEscrow() external view returns (IOursFeeEscrow);
...
/**
 * @notice Minimal ERC-721 receiver signature used by OursLaunchLocker to
...
/**
 * @notice Record kept by OursLaunchFactory for every launch, readable by
 * the locker and by off-chain indexers.
 */
interface IOursLaunchFactory {
...
interface IOursBondingCurve {
    ...
    // Revenue fees are swept by project, asset and historical policy version.
