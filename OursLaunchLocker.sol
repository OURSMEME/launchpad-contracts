...
import {IERC721ReceiverLike} from "./interfaces/ILaunchpad.sol";

/**
 * @title OursLaunchLocker
 * @notice Permanently holds the graduated Uniswap V4 position NFT for every
 * Ours launch. Unlike v1's locker, there is no `collectFees()` here: fee
 * collection and distribution belong entirely to OursMemeHook and
 * OursFeeEscrow, since a V4 position accrues fees inside the singleton
 ...
 */
contract OursLaunchLocker is Ownable2Step, IERC721ReceiverLike {
